    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form action='/resultatInscription.php' method="post" enctype="multipart/form-data">
            <fieldset>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <input type="email" class="form-control" id="username" name="E-mail">
                </div>
              </div>
            </fieldset>
            ...
            <fieldset>
              ...
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="hobbie-ski" name="ski">
                <label class="custom-control-label" for="hobbie-ski">
                  Le ski
                </label>
              </div>
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="hobbie-roller" name="roller">
                <label class="custom-control-label" for="hobbie-roller">
                  Le roller
                </label>
              </div>
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="hobbie-foot" name="foot">
                <label class="custom-control-label" for="hobbie-foot">
                  Le foot
                </label>
              </div>
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="hobbie-basket" name="basket">
